        ...
        <>
            ...
            <nav className="shadow-lg flex justify-between items-center py-2  px-10 min-height-screen">
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn m-1">{user.firstname}</div>
                    ...
                    <div className="flex flex-col gap-5">
                        {
                            problem.map(item => {
                                return <>
                                    <div className="border flex justify-between items-center py-4 px-5 rounded-2xl bg-black text-white h-25">
                                        <div>
                                            <p className="cursor-pointer h-6 transition duration-500 ease-in-out hover:text-blue-500 hover:scale-110 mb-2">{item?.title}</p>
                                            <p className="bg-pink-300 py-1 px-1 w-15 text-center rounded-2xl">{item?.difficultyLevel}</p>
                                        </div>
